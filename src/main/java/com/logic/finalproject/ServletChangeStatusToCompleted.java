...
@WebServlet(name = "ServletChangeStatusToCompleted", value = "/ServletChangeStatusToCompleted")
public class ServletChangeStatusToCompleted extends HttpServlet {

    private static final Logger logger = LoggerFactory.getLogger(ServletChangeStatusToCompleted.class);
...
//            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/final_project", "root", "rost1980");
        ...
        logger.info("Order status was changed to completed");
